...
import ExacerbationsGrid from './ExacerbationsGrid';

const Scoring = () => {
  const [activeCategory, setActiveCategory] = useState('Exacerbations'); 

  const categories = [
    { id: 'Exacerbations', icon: TrendingUp, Component: ExacerbationsGrid },
  ];
