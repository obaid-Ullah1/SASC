...
import ProgressNoteStatusGrid from './ProgressNoteStatusGrid';

const Documentation = () => {
  const [activeCategory, setActiveCategory] = useState('Progress Note Status'); 

  const categories = [
    { id: 'Progress Note Status', icon: FileText, Component: ProgressNoteStatusGrid },
  ];
