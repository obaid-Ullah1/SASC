...
import { Pipette, MapPin, UserRoundCog, AlertTriangle } from 'lucide-react';

// Import the grids we are about to create
import SpecimenTypeGrid from './SpecimenTypeGrid';
import SpecimenSiteGrid from './SpecimenSiteGrid';
import CollectedByRoleGrid from './CollectedByRoleGrid';
import SpecimenConditionGrid from './SpecimenConditionGrid';

const SpecimenDetails = () => {
  const [activeCategory, setActiveCategory] = useState('Specimen Type'); 

  const categories = [
    { id: 'Specimen Type', icon: Pipette, Component: SpecimenTypeGrid },
    { id: 'Specimen Site', icon: MapPin, Component: SpecimenSiteGrid },
    { id: 'Collected By Role', icon: UserRoundCog, Component: CollectedByRoleGrid },
    { id: 'Specimen Condition', icon: AlertTriangle, Component: SpecimenConditionGrid }
  ];
