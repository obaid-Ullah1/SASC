...
import ImagingResultGrid from './ImagingResultGrid';

const Imaging = () => {
  const [activeCategory, setActiveCategory] = useState('Imaging Result'); 

  const categories = [
    { id: 'Imaging Result', icon: ImageIcon, Component: ImagingResultGrid },
  ];
