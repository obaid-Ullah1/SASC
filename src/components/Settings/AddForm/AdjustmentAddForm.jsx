        ...
        <div className="flex flex-col md:flex-row items-start md:items-end gap-4">
          ...
          <div className="flex flex-col gap-1.5 w-full md:w-[180px] shrink-0">
            ...
            <select 
              ...
              required
              className="h-[38px] border-2 border-slate-200 rounded-lg px-2 text-[13px] font-medium text-slate-700 outline-none focus:border-[#00A3FF] focus:ring-4 focus:ring-[#00A3FF]/10 bg-white transition-all w-full"
            >
          ...
          {/* SORT ORDER FIELD */}
          <div className="flex flex-col gap-1.5 w-full md:w-[140px] shrink-0">
            ...
            <input 
              ...
              onChange={handleChange} 
              required
              className="h-[38px] border-2 border-slate-200 rounded-lg px-3 text-[13px] font-medium text-slate-700 outline-none focus:border-[#00A3FF] focus:ring-4 focus:ring-[#00A3FF]/10 transition-all w-full"
            />
          </div>
