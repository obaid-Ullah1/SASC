...
import IndicationGrid from './IndicationGrid';
import TreatmentGoalGrid from './TreatmentGoalGrid';

const TreatmentIndication = () => {
  const [activeCategory, setActiveCategory] = useState('Indication'); 

  const categories = [
    { id: 'Indication', icon: ClipboardList, Component: IndicationGrid },
    { id: 'Treatment Goal', icon: CheckCircle2, Component: TreatmentGoalGrid }
  ];
