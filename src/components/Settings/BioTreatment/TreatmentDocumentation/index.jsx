...
import MedicalNecessityGrid from './MedicalNecessityGrid';
import ReportsUploadedGrid from './ReportsUploadedGrid';

const TreatmentDocumentation = () => {
  const [activeCategory, setActiveCategory] = useState('Medical Necessity'); 

  const categories = [
    { id: 'Medical Necessity', icon: ClipboardPlus, Component: MedicalNecessityGrid },
    { id: 'Reports Uploaded', icon: FileText, Component: ReportsUploadedGrid },
  ];
