...
import { ShieldAlert, CalendarRange, ClipboardCheck } from 'lucide-react';

import SafetyRulesGrid from './SafetyRulesGrid';
import ResponseWindowGrid from './ResponseWindowGrid';
import ResponseCriteriaGrid from './ResponseCriteriaGrid';

const SafetyResponse = () => {
  const [activeCategory, setActiveCategory] = useState('Safety Rules'); 

  const categories = [
    { id: 'Safety Rules', icon: ShieldAlert, Component: SafetyRulesGrid },
    { id: 'Response Window', icon: CalendarRange, Component: ResponseWindowGrid },
    { id: 'Response Criteria', icon: ClipboardCheck, Component: ResponseCriteriaGrid },
  ];
