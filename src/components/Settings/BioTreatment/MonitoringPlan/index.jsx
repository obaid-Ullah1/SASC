...
import { Stethoscope, ClipboardList, Beaker, Image as ImageIcon } from 'lucide-react';

import VitalsMonitoringGrid from './VitalsMonitoringGrid';
import DiseaseScoresGrid from './DiseaseScoresGrid';
import LabMonitoringGrid from './LabMonitoringGrid';
import ImagingOtherGrid from './ImagingOtherGrid';

const MonitoringPlan = () => {
  const [activeCategory, setActiveCategory] = useState('Vitals Monitoring'); 

  const categories = [
    { id: 'Vitals Monitoring', icon: Stethoscope, Component: VitalsMonitoringGrid },
    { id: 'Disease Scores', icon: ClipboardList, Component: DiseaseScoresGrid },
    { id: 'Lab Monitoring', icon: Beaker, Component: LabMonitoringGrid },
    { id: 'Imaging/Other', icon: ImageIcon, Component: ImagingOtherGrid },
  ];
